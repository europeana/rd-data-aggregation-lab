...
public class ClassAlignment {
	...
	Map<String,PropertyAlignment> properties=new HashMapWithFactory<String, PropertyAlignment>(PropertyAlignment.class);
	
//	Set<String> equivalences;
//	Set<String> broaderThan;
	Set<String> alignedWith=new HashSet<String>(); // classes' URIs
