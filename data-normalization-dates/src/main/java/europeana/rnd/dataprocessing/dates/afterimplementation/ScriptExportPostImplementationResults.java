...
public class ScriptExportPostImplementationResults {
...
//			inputFolder = "c://users/nfrei/desktop/data/europeana_dataset";
			outputFolder = "c://users/nfrei/desktop/data/dates-afterimplementation";
			fileFormat ="XML";
		}
		...
		// INIT OPERATIONS
		DatesAfterImplementationHandler[] datesHandlers=new DatesAfterImplementationHandler[] {
				new DatesAfterImplementationHandler(outputFolder),
		};
...
//							double minutesToEnd = (double)(58000000 - recCnt) / recsMinute;
						...
						try {
							for(DatesAfterImplementationHandler handler : datesHandlers)
