...
//			add(DcTerms.coverage);
		...
		public void handle(String choUri, Model edm, int recCnt) throws IOException {
...
//			}
		...
		private boolean isTemporalProp(Property predicate) {
		...
		private void processInnerResource(DatesInRecord res, Resource resource, boolean isEuropeanaProxy, HashSet<Resource> processedResources) {
