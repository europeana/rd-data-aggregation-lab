...
public class ScriptSelectTextFromEuropeanaDataset {
	...
	public static void main(String[] args) throws Exception {
		...
		if (args != null && args.length >= 3) {
			...
			outputFolder = "c://users/nfrei/desktop/data/language-detection";
			fileFormat ="XML";
		}
		...
		// INIT OPERATIONS
		TextHandler handler=new TextHandler(outputFolder);
