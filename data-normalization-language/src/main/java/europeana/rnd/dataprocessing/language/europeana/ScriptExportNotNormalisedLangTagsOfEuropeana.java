...
public class ScriptExportNotNormalisedLangTagsOfEuropeana {
	...
	public static void main(String[] args) throws Exception {
		...
		if (args != null && args.length >= 3) {
			...
			outputFolder = "c://users/nfrei/desktop/data/language/not-normalised-europeana";
			fileFormat ="XML";
...
//			europeana.rnd.dataprocessing.dates.DatesJsonWriter.maxRecsPerFile=50;
		...
		// INIT OPERATIONS
		EuropeanaLangTagHandler handler=new EuropeanaLangTagHandler(outputFolder);
