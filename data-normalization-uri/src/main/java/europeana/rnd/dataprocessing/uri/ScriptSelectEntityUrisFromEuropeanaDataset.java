...
public class ScriptSelectEntityUrisFromEuropeanaDataset {
	...
	public static void main(String[] args) throws Exception {
		...
		if (args != null && args.length >= 3) {
			...
			outputFolder = "c://users/nfrei/desktop/data/uri";
			fileFormat ="XML";
...
//			europeana.rnd.dataprocessing.dates.DatesJsonWriter.maxRecsPerFile=50;
		...
		// INIT OPERATIONS
		EntityUriHandler handler=new EntityUriHandler(outputFolder);
